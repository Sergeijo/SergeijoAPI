...
{
    public class GetUserByIdPresenterUnitTests
    {
        [Fact]
        public void Contains_Ok_Status_Code_When_Use_Case_Succeeds()
        {
            ...
            // act
            presenter.Handle(new GetUserByIdResponse(new User(1, "name", DateTime.Now, "password"), true));
        ...
        public void Contains_Id_When_Use_Case_Succeeds()
        {
            ...
            // act
            presenter.Handle(new GetUserByIdResponse(new User(2, "name", DateTime.Now, "password"), true));
        ...
        public void Contains_Errors_When_Use_Case_Fails()
        {
            ...
            // act
            presenter.Handle(new GetUserByIdResponse(new Core.Dto.Error[] { new Core.Dto.Error("ERR404", "Error Description") }, true));
