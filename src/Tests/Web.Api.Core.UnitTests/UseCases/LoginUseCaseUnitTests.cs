    ...
    public class LoginUseCaseUnitTests
    {
        ...
        public async void Can_Login()
        {
            ...
            mockUserRepository
                ...
                .Returns(Task.FromResult(new User(1, "", DateTime.Now, "")));
            ...
            mockJwtFactory
                .Setup(repo => repo.GenerateEncodedToken(It.IsAny<int>(), It.IsAny<string>()))
                .Returns(Task.FromResult(new Token("", "", 0)));

            var useCase = new LoginAsyncUseCase(mockUserRepository.Object, mockJwtFactory.Object);
            ...
            // act
            var response = await useCase.Handle(new LoginRequest(1, "password"), mockOutputPort.Object);
